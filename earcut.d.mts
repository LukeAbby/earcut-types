...
// Currently the change to `@types/earcut` is in a PR at https://github.com/DefinitelyTyped/DefinitelyTyped/pull/71546.
// Once that is merged this file can go away.
 ...
 * @returns A flat array with each group of three numbers indexing a triangle in the `vertices` array.
 ...
 */
export function flatten(data: ArrayLike<ArrayLike<ArrayLike<number>>>): {
  vertices: number[];
  holes: number[];
  dimensions: number;
};
